...
class _$ErrorResponseImpl implements _ErrorResponse {
  const _$ErrorResponseImpl({this.code, this.description});
  ...
  @override
  String toString() {
    return 'ErrorResponse(code: $code, description: $description)';
  }
...
abstract class _ErrorResponse implements ErrorResponse {
  const factory _ErrorResponse(
      {final String? code, final String? description}) = _$ErrorResponseImpl;
